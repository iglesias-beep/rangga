...
const T = {
    ID: {
        ...
        card_img_1: "Proyek 1", card_title_1: "REST API E-Commerce",
        card_desc_1: "Backend API lengkap untuk platform e-commerce dengan autentikasi JWT, payment gateway, dan real-time notifications.",
        card_img_2: "Proyek 2", card_title_2: "Real-time Chat System",
        card_desc_2: "WebSocket-based chat system dengan message queue, caching layer, dan support untuk 10K+ concurrent users.",
        card_img_3: "Proyek 3", card_title_3: "Microservices Platform",
        card_desc_3: "Arsitektur microservices untuk SaaS platform dengan auto-scaling, service mesh, dan monitoring dashboard.",
        card_img_4: "Proyek 4", card_title_4: "Auth & Security Layer",
        card_desc_4: "Sistem autentikasi & otorisasi terpusat dengan OAuth2, rate limiting, dan intrusion detection system.",
    ...
    EN: {
        ...
        card_img_1: "Project 1", card_title_1: "E-Commerce REST API",
        card_desc_1: "Complete backend API for an e-commerce platform with JWT auth, payment gateway, and real-time notifications.",
        card_img_2: "Project 2", card_title_2: "Real-time Chat System",
        card_desc_2: "WebSocket-based chat system with message queue, caching layer, and support for 10K+ concurrent users.",
        card_img_3: "Project 3", card_title_3: "Microservices Platform",
        card_desc_3: "Microservices architecture for a SaaS platform with auto-scaling, service mesh, and monitoring dashboard.",
        card_img_4: "Project 4", card_title_4: "Auth & Security Layer",
        card_desc_4: "Centralized auth & authorization system with OAuth2, rate limiting, and intrusion detection system.",
